...
void panel(void)
{
	...
	DGOUT_PROC( 30, F0914, HIGH ); // top
	DGOUT_PROC( 31, F0915, HIGH ); // right_top
	DGOUT_PROC( 32, F0916, HIGH ); // right_bottom
	DGOUT_PROC( 33, F0917, HIGH ); // bottom
	DGOUT_PROC( 51, F0918, HIGH ); // left_bottom
	DGOUT_PROC( 52, F0919, HIGH ); // left_top
	DGOUT_PROC( 53, F0920, HIGH ); // middle
	DGOUT_PROC( 54, F1321, HIGH ); // dot
}
